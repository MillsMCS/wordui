...
public class FXMLController implements Initializable {
	...
	private ChangeListener<WordRecord.SortOrder> sortOrderChangeListener = new SortOrderChangeListener();
	...
	private void addListeners() {
		...
		sortChoiceBox.getSelectionModel().selectedItemProperty().addListener(sortOrderChangeListener);
	}
