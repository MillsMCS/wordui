...
public class WordRecord {
	/*
	 * private static Comparator<WordRecord> azComparator = new
	 * Comparator<WordRecord>() {
	 *
	 * @Override public int compare(WordRecord wr1, WordRecord wr2) { return
	 * wr1.getWord().compareToIgnoreCase(wr2.getWord()); } };
	 */
	private static Comparator<WordRecord> azComparator = (wr1, wr2) -> wr1.getWord().compareToIgnoreCase(wr2.getWord());
	private static Comparator<WordRecord> zaComparator = (wr1, wr2) -> wr2.getWord().compareToIgnoreCase(wr1.getWord());
	private static Comparator<WordRecord> increasingFreqComparator = (wr1, wr2) -> wr1.getFrequency()
			.compareTo(wr2.getFrequency());
	private static Comparator<WordRecord> decreasingFreqComparator = (wr1, wr2) -> wr2.getFrequency()
			.compareTo(wr1.getFrequency());
